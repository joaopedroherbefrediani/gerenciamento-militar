...
interface ConfirmarExclusaoMaterialCursoModalProps {
  isOpen: boolean
  onClose: () => void
...
export default function ConfirmarExclusaoMaterialCursoModal({
  isOpen,
  onClose,
  onConfirm,
  cursoNome,
  materialNome,
}: ConfirmarExclusaoMaterialCursoModalProps) {
      ...
      <div className="bg-white rounded-lg shadow-xl w-full">
        ...
        <div className="p-6">
          <p className="text-gray-700 mb-6">
            ...
            <span className="font-semibold">&quot;{materialNome}&quot;</span> do curso{' '}
            <span className="font-semibold">&quot;{cursoNome}&quot;</span>?
            <br />
            <span className="text-gray-600">Esta ação não pode ser desfeita.</span>
          </p>
